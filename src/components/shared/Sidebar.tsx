/**
 * components/shared/Sidebar.tsx — Menú Lateral con Selector de Proyecto
 */
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-1 space-y-4">
        {MENU_ITEMS.map((group) => {
          ...
          return (
            <div key={group.label}>
              {!collapsed && (
                <p className="text-[10px] font-semibold text-[#a8a0b8] uppercase tracking-wider px-3 mb-1">{group.label}</p>
              )}
